...
const REDIRECTS = {
  '/index.html': '/',
  '/veilige-douche/': '/inloopdouche/',
  '/seniorendouches/': '/inloopdouche/',
  '/onze-douches/': '/douchecabine/',
  '/kocoon/': '/douchecabine/',
  '/vervang-je-bad-door-een-veilige-kinemagic-douchecabine/': '/douchecabine/',
  '/onze-toiletten/': '/',
  ...
  '/faq/een-bad-vervangen-door-een-douche-hoe-gaat-dat-in-zijn-werk/': '/inloopdouche/',
  '/faq/kan-ck-service-mijn-douche-aanpassen-voor-senioren/': '/inloopdouche/',
  '/faq/vanaf-welke-leeftijd-heb-ik-een-senioren-badkamer-nodig/': '/inloopdouche/',
  '/faq/kan-ckservice-een-douchestoel-plaatsen/': '/inloopdouche/',
  ...
  '/faq/hangtoilet-plaatsen/': '/faq/',
  '/faq/wat-is-japans-toilet/': '/faq/',
  '/faq/wat-zijn-de-voordelen-van-een-douchetoilet/': '/faq/',
